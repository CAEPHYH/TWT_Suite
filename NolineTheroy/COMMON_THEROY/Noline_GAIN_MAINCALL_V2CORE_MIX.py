...
def calculate_SEGMENT_TWT_NOLINE(
    I, V, Kc, Loss_perunit, p_SWS, N_unit, w, t, Fn_K, f0_GHz, Vpc, P_in=0.1, Loss_attu=20
):# 根据N_unit构建SEGMENTS
    SEGMENTS = [{"len": n, "Vpc": Vpc, "Kc": Kc,"p_SWS": p_SWS, "Loss_perunit": Loss_perunit} for n in N_unit]

    COMMON_PARAMS = {"I": I, "V": V, "w": w, "t": t, "Fn_K": Fn_K,"f0_GHz": f0_GHz, }
