...
def main():
    # ========================= 多段参数配置 =========================
    SEGMENTS = [
        {"len": 20, "Vpc": 0.3010625489991999, "p_SWS": 0.75, "Kc": 2.6465458570716063, "f0_GHz": 160, "type": "initial"},
        {"len": 30, "Vpc": 0.3010625489991999, "p_SWS": 0.75, "Kc": 2.6465458570716063, "f0_GHz": 160, "type": "attenuator"},
        # {"len": 35, "Vpc": 0.2863221197711839, "p_SWS": 0.48, "Kc": 1.482151647681497, "f0_GHz": 220, "type": "attenuator"},
        # {"len": 1, "Vpc": 0.2863221197711839, "p_SWS": 0.48, "Kc": 1.482151647681497, "f0_GHz": 220, "type": "attenuator"},
        # {"len": 35, "Vpc": 0.2863221197711839, "p_SWS": 0.48, "Kc": 1.482151647681497, "f0_GHz": 220, "type": "O"},
    ]
    Loss_attu = 14

    # ========================= 全局参数 =========================
    COMMON_PARAMS = {
        "I": 0.4, "V": 25000, "Loss": 0,
        "w": 0.77, "t": 0.11, "Fn_K": 1.4
    }
