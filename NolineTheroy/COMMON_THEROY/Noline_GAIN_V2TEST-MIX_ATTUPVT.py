...
def main():
    # ========================= 多段参数配置 =========================
    SEGMENTS = [
        {"len": 30, "Vpc": 0.287, "p_SWS": 0.50, "Kc": 3.6, "Loss_perunit": 0, "type": "initial"},
        {"len": 5, "Vpc": 0.287, "p_SWS": 0.50, "Kc": 3.6, "Loss_perunit": 0, "type": "attenuator"},
        {"len": 5, "Vpc": 0.287, "p_SWS": 0.50, "Kc": 3.6, "Loss_perunit": 0, "type": "O"},
        {"len": 5, "Vpc": 0.287, "p_SWS": 0.50, "Kc": 3.6, "Loss_perunit": 0, "type": "attenuator"},
        {"len": 5, "Vpc": 0.287, "p_SWS": 0.50, "Kc": 3.6, "Loss_perunit": 0, "type": "O"},
    ]
    Loss_attu = 20
