...
def main():
    # ========================= 多段参数配置 =========================
    SEGMENTS = [
        {"len": 30, "Vpc": 0.288, "p_SWS": 0.50, "Kc": 3.6,  "type": "initial"},
        {"len": 5, "Vpc": 0.288, "p_SWS": 0.50, "Kc": 3.6,  "type": "attenuator"},
        {"len": 5, "Vpc": 0.288, "p_SWS": 0.50, "Kc": 3.6,  "type": "O"},
        {"len": 5, "Vpc": 0.288, "p_SWS": 0.50, "Kc": 3.6,  "type": "attenuator"},
        {"len": 5, "Vpc": 0.288, "p_SWS": 0.50, "Kc": 3.6,  "type": "O"},
    ]
    Loss_attu = 0
    ...
    # ========================= 全局参数 =========================
    COMMON_PARAMS = {
        "I": 0.30, "V": 23000,"f0_GHz": 211, "Loss_perunit": 0,
