...
def main():
    # ========================= 多段参数配置 =========================
    SEGMENTS = [
        {"len": 25, "Vpc": 0.288, "p_SWS": 0.50, "Kc": 3.6, "f0_GHz": 211,"Loss_perunit": 0,"Fn_K": 1, "type": "initial"},
        {"len": 1, "Vpc": 0.288, "p_SWS": 0.50, "Kc": 3.6, "f0_GHz": 211,"Loss_perunit": 0,"Fn_K": 1, "type": "attenuator"},
        {"len": 24, "Vpc": 0.288, "p_SWS": 0.50, "Kc": 3.6, "f0_GHz": 211,"Loss_perunit": 0,"Fn_K": 1, "type": "O"},
        # {"len": 50, "Vpc": 0.2893, "p_SWS": 0.50, "Kc": 3.88, "f0_GHz": 211,"Loss_perunit": 0,"Fn_K": 1, "type": "attenuator"},
        # {"len": 50, "Vpc": 0.2893, "p_SWS": 0.50, "Kc": 3.88, "f0_GHz": 211,"Loss_perunit": 0,"Fn_K": 1, "type": "O"},
...
def build_input_params(common_params, seg):
    """构建输入参数列表"""
    return [
        common_params["I"], common_params["V"], seg["Kc"], common_params["Loss_perunit"],
