...
def main():
    # ========================= 多段参数配置 =========================
    SEGMENTS = [
        {"len": 30, "Vpc": 0.288, "p_SWS": 0.50, "Kc": 3.6, "Loss_perunit": 0,"Fn_K": 1, "type": "initial"},
        {"len": 5, "Vpc": 0.288, "p_SWS": 0.50, "Kc": 3.6, "Loss_perunit": 0.0,"Fn_K": 1, "type": "O"},
        {"len": 5, "Vpc": 0.286, "p_SWS": 0.45, "Kc": 3.0, "Loss_perunit": 0.05,"Fn_K": 1.1, "type": "O"},#倍频段起始
        {"len": 5, "Vpc": 0.286, "p_SWS": 0.45, "Kc": 3.0, "Loss_perunit": 0.05,"Fn_K": 1.1, "type": "O"},
        {"len": 5, "Vpc": 0.286, "p_SWS": 0.45, "Kc": 3.0, "Loss_perunit": 0.05,"Fn_K": 1.1, "type": "O"},
    ]
    Loss_attu = 20
