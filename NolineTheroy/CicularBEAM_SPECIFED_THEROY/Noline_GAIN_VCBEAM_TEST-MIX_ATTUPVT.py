...
def main():
    # ========================= 多段参数配置 =========================
    SEGMENTS = [
        {"len": 20, "Vpc": 0.2893778968136611, "p_SWS": 0.50, "Kc": 3.8812150306728705, "Loss_perunit": 0, "type": "initial"},
        {"len": 30, "Vpc": 0.2893778968136611, "p_SWS": 0.50, "Kc": 3.8812150306728705, "Loss_perunit": 0, "type": "attenuator"},
