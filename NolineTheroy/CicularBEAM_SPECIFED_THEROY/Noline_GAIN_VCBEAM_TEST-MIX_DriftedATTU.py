...
def main():
    # ========================= 多段参数配置 =========================
    SEGMENTS = [
        {"len": 25, "Vpc": 0.2893778968136611, "p_SWS": 0.50, "Kc": 3.8812150306728705, "f0_GHz": 211,"Loss": 0,"Fn_K": 1, "type": "initial"},
        {"len": 7, "Vpc": 0.2893778968136611, "p_SWS": 0.50, "Kc": 3.8812150306728705, "f0_GHz": 211,"Loss": 0,"Fn_K": 1, "type": "attenuator"},
        {"len": 25, "Vpc": 0.2893778968136611, "p_SWS": 0.50, "Kc": 3.8812150306728705, "f0_GHz": 211,"Loss": 0,"Fn_K": 1, "type": "O"},
        # {"len": 1, "Vpc": 0.288, "p_SWS": 0.50, "Kc": 3.6, "f0_GHz": 211,"Loss": 0,"Fn_K": 1, "type": "attenuator"},
        # {"len": 17, "Vpc": 0.288, "p_SWS": 0.50, "Kc": 3.6, "f0_GHz": 211,"Loss": 0,"Fn_K": 1, "type": "O"},
        # {"len": 12, "Vpc": 0.288, "p_SWS": 0.50, "Kc": 3.6, "f0_GHz": 211, "type": "O"},
    ]
    Loss_attu = 20
...
def build_input_params(common_params, seg):
    """构建输入参数列表"""
    return [
        common_params["I"], common_params["V"], seg["Kc"], seg["Loss"],
        seg["p_SWS"], seg["len"], common_params["w"], common_params["t"],
        seg["Fn_K"], seg["f0_GHz"], seg["Vpc"]
    ]
