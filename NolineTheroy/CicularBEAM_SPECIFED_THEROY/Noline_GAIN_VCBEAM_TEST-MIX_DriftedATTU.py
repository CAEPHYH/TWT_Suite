...
def main():
    # ========================= 多段参数配置 =========================
    SEGMENTS = [
        {"len": 25, "Vpc": 0.288, "p_SWS": 0.50, "Kc": 3.6, "Loss_perunit": 0,"Fn_K": 1, "type": "initial"},
        {"len": 7, "Vpc": 0.288, "p_SWS": 0.50, "Kc": 3.6, "Loss_perunit": 0,"Fn_K": 1, "type": "attenuator"},
        {"len": 25, "Vpc": 0.288, "p_SWS": 0.50, "Kc": 3.6, "Loss_perunit": 0,"Fn_K": 1, "type": "O"},
    ]
    Loss_attu = 20
