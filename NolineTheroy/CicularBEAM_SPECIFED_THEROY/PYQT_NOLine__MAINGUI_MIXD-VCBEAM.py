...
from Noline_GAIN_MAINCALL_VCBEAMCORE_SUPER_MIX import calculate_SEGMENT_TWT_NOLINE
    ...
    def calculate(self):
        try:
            ...
            with open(save_path, 'w', encoding='utf-8') as f:
                f.write("Frequency(GHz),Combined_power(W),Kc(Ohm),Loss_perunit,Vpc(c),N_Units,P_in(W),Loss_attu(dB/m)\n")
                ...
                for p in var_params:
                    ...
                    f.write(f"{p['Freq']},{total_power},{p['Kc']},{p['Loss_perunit']},{p['Vpc']},\"{n_units}\",{fixed_params['P_in']},{fixed_params['Loss_attu']}\n")
