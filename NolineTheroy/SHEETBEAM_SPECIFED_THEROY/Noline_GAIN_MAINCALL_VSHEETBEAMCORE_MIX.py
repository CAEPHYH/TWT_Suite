...
def calculate_SEGMENT_TWT_NOLINE(I, V, Kc, Loss, p_SWS, N_unit, w, t, Fn_K, f0_GHz, Vpc):
    # 根据N_unit构建SEGMENTS
    SEGMENTS = [{
        "len": n,
        "Vpc": Vpc,
    ...
    for seg_idx, seg in enumerate(SEGMENTS):
        ...
        if seg_idx == 0:
            ...
            params = {
                "C": C, "b": b, "d": d, "beam_params": beam_params, "m": 100, "A0": A0, "y_end": L
            }
            print(params)
            ...
            params = {
                "C": C, "b": b, "d": d, "beam_params": beam_params, "m": 100,
                "result_y_ends": prev_result["y"][-1],
                "result_A_ends": prev_result["A_Ends"] * 1e-1,
