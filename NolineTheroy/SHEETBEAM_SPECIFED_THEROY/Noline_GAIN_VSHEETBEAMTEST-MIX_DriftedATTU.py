...
from Noline_GAIN_MAINCALL_VSHEETBEAMCORE_MIX_M import solveTWTNOLINE_OUTPUT, solveTWTNOLINE_INIT,solveTWTNOLINE_Drift

def main():
    # ========================= 多段参数配置 =========================
    SEGMENTS = [
        {"len": 25, "Vpc": 0.28819573868914794, "p_SWS": 0.50, "Kc": 3.36324760989153, "f0_GHz": 214, "type": "initial"},
        {"len": 5, "Vpc": 0.28819573868914794, "p_SWS": 0.50, "Kc": 3.36324760989153, "f0_GHz": 214, "type": "attenuator"},
        {"len": 25, "Vpc": 0.28819573868914794, "p_SWS": 0.50, "Kc": 3.36324760989153, "f0_GHz": 214, "type": "O"},
        # {"len": 5, "Vpc": 0.288, "p_SWS": 0.50, "Kc": 3.6, "f0_GHz": 211, "type": "attenuator"},
        # {"len": 20, "Vpc": 0.288, "p_SWS": 0.50, "Kc": 3.6, "f0_GHz": 211, "type": "O"},
        # {"len": 5, "Vpc": 0.288, "p_SWS": 0.50, "Kc": 3.6, "f0_GHz": 211, "type": "O"},
    ]
    Loss_attu = 20
    ...
    for seg_idx, seg in enumerate(SEGMENTS):
        ...
        Rn_sqr_values=get_plasma_factor(calc_result, input_params[6], input_params[7])**2
...
def build_input_params(common_params, seg):
    """构建输入参数列表"""
    return [
        common_params["I"], common_params["V"], seg["Kc"], common_params["Loss"],
        seg["p_SWS"], seg["len"], common_params["w"], common_params["t"],
        common_params["Fn_K"], seg["f0_GHz"], seg["Vpc"]
    ]
