...
def main():
    ...
    SEGMENTS = [
        ...
        {"len": 5, "Vpc": 0.2876, "p_SWS": 0.495, "Kc": 3.5424, "Loss_perunit": 0.0,"Fn_K": 2, "type": "O"},
        {"len": 5, "Vpc": 0.287, "p_SWS": 0.15, "Kc": 3.0, "Loss_perunit": 0.1,"Fn_K": 1.2, "type": "O"},#倍频段起始
        {"len": 5, "Vpc": 0.279, "p_SWS": 0.145, "Kc": 2.84, "Loss_perunit": 0.1,"Fn_K": 1.2, "type": "O"},
        {"len": 5, "Vpc": 0.271, "p_SWS": 0.14, "Kc": 2.68, "Loss_perunit": 0.1,"Fn_K": 1.2, "type": "O"},
    ]
    Loss_attu = 20
