...
class FixedParamsEditor(BaseEditor):
    ...
    def __init__(self, parent=None):
        fields = [
            ...
            ("慢波结构参数", "label"),
            ("倍频前Kc值 (Ω):", "double", 0, 10, 3.6, 0.001, 4),
            ("倍频段Kc值 (Ω):", "double", 0, 10, 3.0, 0.001, 4),
            ("倍频前每单元损耗:", "double", 0, 1e3, 0.0, 0.001, 4),
            ("倍频段每单元损耗:", "double", 0, 1e3, 0.1, 0.001, 4),
            ("衰减段索引 (逗号分隔):", "text", "1"),
            ...
            ("倍频段填充因子:", "double", 1, 10, 1.2, 0.001, 4),
            
            ("频率参数", "label"),
            ("工作频率 (GHz):", "double", 0, 3000, 211.0, 1, 1),
            
            ("输入/衰减参数", "label"),
            ("输入功率 (W):", "double", 0, 100, 0.1, 0.001, 4),
            ("衰减量 (dB):", "double", 0, 100, 15, 1, 1),
            
            ("相位参数", "label"),
            ("倍频前Vpc值 (c):", "double", 0, 1, 0.290, 0.001, 4),
            ("倍频段Vpc值 (c):", "double", 0, 1, 0.287, 0.001, 4),
...
class DDEConfigEditor(BaseEditor):
    ...
    def __init__(self, parent=None):
        fields = [
            ...
            ("p_SWS下限 (逗号分隔):", "text", "0.499,0.490,0.49,0.49,0.49"),
            ("p_SWS上限 (逗号分隔):", "text", "0.501,0.510,0.51,0.51,0.51"),
...
class InitialParamsEditor(BaseEditor):
    ...
    def __init__(self, parent=None):
        fields = [
            ("初始p_SWS值 (逗号分隔):", "text", "0.50,0.495,0.15,0.145,0.140"),
        ]
        super().__init__(fields, parent)
