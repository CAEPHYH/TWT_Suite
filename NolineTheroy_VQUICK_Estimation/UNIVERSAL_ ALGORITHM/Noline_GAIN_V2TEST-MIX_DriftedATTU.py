...
def main():
    # ========================= 多段参数配置 =========================
    SEGMENTS = [
        {"len": 25, "Vpc": 0.288, "p_SWS": 0.50, "Kc": 3.6, "Fn_K": 1, "type": "initial"},
        {"len": 1, "Vpc": 0.288, "p_SWS": 0.50, "Kc": 3.6, "Fn_K": 1, "type": "attenuator"},
        {"len": 24, "Vpc": 0.288, "p_SWS": 0.50, "Kc": 3.6, "Fn_K": 1, "type": "O"},
    ]
    Loss_attu = 0
    ...
    COMMON_PARAMS = {
        ...
        "w": 0.20, "t": 0.20, "Fn_K": 1,"f0_GHz": 211,
    }
