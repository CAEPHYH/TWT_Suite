...
import matplotlib.pyplot as plt
import numpy as np
from _TWT_CORE_NOLINE_COMPLEX_VSHEETBEAM_DEV import solveTWTNOLINE_INIT_V2,solveTWTNOLINE_INIT_V2Z,solveTWTNOLINE_INITR
...
if __name__ == "__main__":
    ...
    if method==1:
        ...
        paramsR = {"C": C,  "b": b,  "d": d,  "beam_params": beam_paramsR,  "m": 50,  "A0": A_0,  "y_end": L}
        print(paramsR)
