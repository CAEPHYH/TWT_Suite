...
import matplotlib.pyplot as plt
import numpy as np
from _TWT_CORE_NOLINE_COMPLEX_VSHEETBEAM_DEV import (
    solveTWTNOLINE_INIT_V2,
    solveTWTNOLINE_INIT_V2Z,
    solveTWTNOLINE_INITR,
)
...
if __name__ == "__main__":
    ...
    Space_CUT = 10
    beam_paramsR = [Rn_sqr_values, wp_w, Space_CUT,freq,V_beam]
    # 束流参数beam_paramsR
    ...
    method = 0
    if method == 1:
        result = solveTWTNOLINE_INIT_V2Z(
            **params
        ...
        print(paramsR)
        result = solveTWTNOLINE_INITR(**paramsR)
