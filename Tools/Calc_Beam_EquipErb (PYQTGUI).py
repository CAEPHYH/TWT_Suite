...
class MainWindow(QMainWindow):
    ...
    def create_input_tab(self):
        ...
        param_definitions = [
            ...
            ('U', '电压 (V)', 100, 50000),
            ('f0_GHz', '频率 (GHz)', 1, 500),
            ('a_WG', '波导宽 a (mm)', 0.1, 10),
            ('b_WG', '波导高 b (mm)', 0.1, 10),
            ('Kc', '耦合系数', 0.1, 5),
    ...
    def create_results_tab(self):
        ...
        self.results_table.setHorizontalHeaderLabels(["点号", "A", "u", "ε_res"])
    ...
    def update_results_tab(self, results):
        ...
        ax.set_xlabel('A')
        ax.set_ylabel('相对介电常数 ε_res')
        ax.set_title('相对介电常数随A的变化')
        ax.grid(True)
        ax.legend()
        ...
        self.results_table.setItem(0, 2, QTableWidgetItem("Ez平均"))
        self.results_table.setItem(0, 3, QTableWidgetItem(f"{np.mean(results['Ez']):.4e}"))
    ...
    def export_results(self):
        ...
        try:
            with open(filename, 'w', newline='', encoding='utf-8') as csvfile:
                ...
                # 写入标题行
                csvwriter.writerow(['点号', 'A', 'u', '相对介电常数 ε_res'])
